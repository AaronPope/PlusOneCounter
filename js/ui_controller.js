...
var players = [new Player("Player 1", 0), new Player("Player 2", 0)];
var testGame = new Game();
var numberOfPlayers = 2;
var defaultPlayerNameText = "Who's playing? Click to enter your name.";

var closePlayerDiv = '<div class="remove-player">X</div>'
...
//    ++numberOfPlayers;
    players[numberOfPlayers] = new Player("Player " + ++numberOfPlayers, 0);
    
    console.log("addNewPlayerDiv() triggered...");
    $("#players").append('<input type="text" id="player-' + numberOfPlayers + '-name" class="player-name-field" placeholder="Player ' + numberOfPlayers + '"/>'
...
var nameBoxFocusIn = function(element) {
}
